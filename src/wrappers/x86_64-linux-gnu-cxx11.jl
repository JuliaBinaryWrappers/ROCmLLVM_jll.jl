# Autogenerated wrapper script for ROCmLLVM_jll for x86_64-linux-gnu-cxx11
export clang, ld_lld, libclang, libclang_cpp, libclangbasic, libllvmcore, liblto, llc, lld, llvm_config, opt

using Zlib_jll
JLLWrappers.@generate_wrapper_header("ROCmLLVM")
JLLWrappers.@declare_library_product(libclang, "libclang.so.13")
JLLWrappers.@declare_library_product(libclang_cpp, "libclang-cpp.so.14git")
...
JLLWrappers.@declare_library_product(liblto, "libLTO.so.14git")
